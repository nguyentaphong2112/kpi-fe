...
export class Constant {
  ...
  public static readonly CATEGORY = {
    ...
    INCOME_ITEM_MASTERS_STATUS: 'INCOME_ITEM_MASTERS_STATUS',
    PIT_TRANG_THAI_TNCN: 'PIT_TRANG_THAI_TNCN',
    KHOAN_THU_NHAP: 'KHOAN_THU_NHAP',
  };

  public static readonly TAX_DECLARE_MASTERS_STATUS = {
    DU_THAO: 'DU_THAO',
    DA_QUYET_TOAN: 'DA_QUYET_TOAN',
    DA_CHOT: 'DA_CHOT',
  };

  public static readonly KHOAN_THU_NHAP_STATUS = {
    DA_SU_DUNG: 1,
    CHUA_SU_DUNG: 0,
  };

  public static readonly INCOME_ITEM_MASTER = {
    DU_THAO: 'DU_THAO',
    DA_QUYET_TOAN: 'DA_QUYET_TOAN',
    DA_CHOT: 'DA_CHOT',
    DA_KE_KHAI: 'DA_KE_KHAI',
  ...
  public static readonly SelectPitInputType = [
    { id: 'CALCULATE', name: 'Dữ liệu kê khai', translate: '' },
    { id: 'IMPORT', name: 'Dữ liệu import', translate: '' }
  ];
