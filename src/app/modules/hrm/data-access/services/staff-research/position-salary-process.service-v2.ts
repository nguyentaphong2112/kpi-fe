...
export class PositionSalaryProcessServiceV2 extends BaseCrudService<PositionSalaryProcessModel> {
  protected override serviceName = MICRO_SERVICE.HRM;
  protected override urlEndpoint = '/v2/position-salary-process';
}