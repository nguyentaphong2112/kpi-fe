...
export class WorkInfoService extends BaseCrudService<NzSafeAny>{
  protected override urlEndpoint = UrlConstant.API_VERSION + UrlConstant.WORK_PROCESS.PREFIX;
  ...
  public getTableList(employeeId: number | any, param: any): Observable<BaseResponse> {
    this.resetRequest();
    const url = this.urlEndpoint + UrlConstant.WORK_PROCESS.LIST.replace('/{employeeId}', employeeId ? ('/' + employeeId.toString()) : UrlConstant.EMPLOYEES.PERSONAL);
