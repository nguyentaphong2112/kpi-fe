...
export class CtsIndexComponent extends BaseListComponent<CourseTraineesModel> implements OnInit {
    ...
    this.tableConfig.headers = [
      {
        ...
        {
          title: 'crm.courseTrainees.table.courseTraineeId',
          field: 'courseTraineeId',
          width: 120,
          tdClassList: ['text-center'],
          thClassList: ['text-center']
        },
        {
          title: 'crm.courseTrainees.table.courseId',
          field: 'courseId',
          width: 120,
          tdClassList: ['text-center'],
          thClassList: ['text-center']
        ...
        {
          title: 'crm.courseTrainees.table.traineeId',
          field: 'traineeId',
          width: 120,
          tdClassList: ['text-center'],
          thClassList: ['text-center']
        ...
        {
          title: 'crm.courseTrainees.table.instructorId',
          field: 'instructorId',
          width: 120,
          tdClassList: ['text-center'],
          thClassList: ['text-center']
