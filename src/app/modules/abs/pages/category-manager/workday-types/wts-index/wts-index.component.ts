...
@Component({
  selector: 'app-wts-index',
  templateUrl: './wts-index.component.html',
  styleUrls: ['./wts-index.component.scss']
})


export class WtsIndexComponent extends BaseListComponent<WorkdayTypesModel> implements OnInit {
    ...
    this.tableConfig.headers = [
      {
        ...
        {
          title: 'abs.workdayTypes.table.code',
          field: 'code',
          width: 120,
        },
        {
          title: 'abs.workdayTypes.table.name',
          field: 'name',
          width: 120,
        },
        {
