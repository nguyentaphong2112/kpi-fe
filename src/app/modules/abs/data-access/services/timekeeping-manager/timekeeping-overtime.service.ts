...
export class TimekeepingOvertimeService extends BaseCrudService<TimekeepingsModel> {
  protected override serviceName = MICRO_SERVICE.ABS;
  protected override urlEndpoint = '/v1/time-keeping/LAM_THEM';


  timekeepingAuto(data: any) {
    this.resetRequest();
    const url = `${UrlConstant.API_VERSION}${UrlConstant.SEARCH_FORM.TIMEKEEPING_AUTO}/LAM_THEM`
