...
@Component({
  selector: 'pes-form',
  templateUrl: './pes-form.component.html',
  styleUrls: ['./pes-form.component.scss']
})
export class PesFormComponent extends BaseFormComponent<NzSafeAny> implements OnInit {
  employeeCode = '';
  employeeName = '';
  ...
  override back() {
    CommonUtils.setFormSearchToLocalStorageByName('provides-pes-form', true);
    super.back();
  }
