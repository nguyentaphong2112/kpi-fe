...
@Component({
  selector: 'app-mia-equipment-list',
...
export class EquipmentListComponent extends BaseListComponent<any> implements OnInit {
  ...
  @ViewChild('totalQuantityTmpl', {static: true}) totalQuantity!: TemplateRef<any>;
  ...
  override setHeaders() {
    ...
    this.tableConfig.headers = [
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.equipmentType',
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.name',
        field: 'name',
        width: 120,
      },
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.code',
        field: 'code',
        width: 120,
        tdClassList: ['text-center'],
        thClassList: ['text-center']
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.equipmentUnit',
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.inventoryQuantity',
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.quantity',
      ...
      {
        title: 'mat.matInventoryAdjustments.listEquipments.table.totalQuantity',
        field: 'totalQuantity',
        fieldType: 'tdTemplate',
        fieldTypeValue: this.totalQuantity,
        tdClassList: ['text-right'],
        thClassList: ['text-center'],
        width: 120,
      },
