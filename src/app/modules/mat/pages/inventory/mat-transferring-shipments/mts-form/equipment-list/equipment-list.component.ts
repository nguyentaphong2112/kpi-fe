...
@Component({
  selector: 'app-mts-equipment-list',
...
export class EquipmentListComponent  extends BaseListComponent<any> implements OnInit, AfterViewInit {
  ...
  override setHeaders() {
    ...
    this.tableConfig.headers = [
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.equipmentType',
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.name',
        field: 'equipmentName',
        width: 120,
      },
      {
        title: 'mat.matTransferringShipments.listEquipments.table.code',
        field: 'equipmentCode',
        width: 120,
        tdClassList: ['text-center'],
        thClassList: ['text-center']
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.equipmentUnit',
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.inventoryQuantity',
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.quantity',
        field: 'quantity',
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.unitPrice',
        field: 'unitPrice',
        width: 120,
        fieldType: 'tdTemplate',
      ...
      {
        title: 'mat.matTransferringShipments.listEquipments.table.amount',
        field: 'amount',
        fieldType: 'tdTemplate',
